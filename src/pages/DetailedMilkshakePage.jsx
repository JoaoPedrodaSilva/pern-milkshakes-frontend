            ...
            {selectedMilkshake && (
                <section className="flex flex-col justify-center items-center gap-3 px-4">
                    ...
                    <img
                        ...
                        alt=""
                        className="w-1/2 rounded-lg border border-white"
                    />
                    <p className="text-xs xs:rg-red-300 text-justify">{selectedMilkshake.long_description}</p>
                    <Link to="/" className="text-center text-xs bg-orange-400 rounded px-2 py-1">Back to Milkshakes</Link>
                </section>
            )}
        </>
    )
